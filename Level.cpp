...
namespace Level_Space {
	...
	void Level::createLevel (Ogre::SceneManager* scene_manager) {
		...
		case 0: 
			...
			enemies.push_back(new Enemy_Space::Enemy (scene_manager, Ogre::Vector3 (0.0f, 0.0f, 550.0f), 4));
			enemies.push_back(new Enemy_Space::Enemy (scene_manager, Ogre::Vector3 (200.0f, 100.0f, 650.0f), 4));
