...
namespace Enemy_Space {
	...
	public:
		Enemy (void);
		Enemy (Ogre::SceneManager* scene_manager, Ogre::String name, Ogre::Vector3 initalPosition, int enemy_num = 4);
		~Enemy (void);
	...
	protected:
		...
		void createEnemyByNum (Ogre::SceneManager*, Ogre::String, Ogre::Vector3, int num = 4);	
		void CreateEnemy1 (Ogre::SceneManager*, Ogre::String, Ogre::Vector3);
		void CreateEnemy2 (Ogre::SceneManager*, Ogre::String, Ogre::Vector3);
		void CreateEnemy3 (Ogre::SceneManager*, Ogre::String, Ogre::Vector3);
		void CreateEnemy4 (Ogre::SceneManager*, Ogre::String, Ogre::Vector3);
		void CreateEnemy5 (Ogre::SceneManager*, Ogre::String, Ogre::Vector3);
